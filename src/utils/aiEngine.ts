...
【追加指示（重要）】
1. 記事冒頭に必ず「リード文（導入）」を1段落入れてください。
   - 読者が内容に興味を持つように、背景・問題提起・簡単な要約を書く。
2. 次に「本文へ引き込む導入（つかみ）」として1段落書く。
   - 続きを読みたくなるように期待を高める文章にする。
3. その後に <h3> から始まる本文構造を出力する。
...
{
  "title": "タイトル",
  "content": "<p>リード文...</p><p>つかみ...</p><h3>...</h3><p>...</p>"
}
`;
}
